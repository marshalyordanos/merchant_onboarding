...
export const TermsForm = forwardRef(
  (
    props: {
    ...
    //     props.onSubmit(props.agreement);
    ...
    const handleChange = () => {
      props.setAggrement(!props.agreement);
    };
      ...
      <div className="terms-container">
        ...
        <div className="terms-content">
          <p>
            ...
            terms and conditions. These terms govern your relationship with
            LakiPay and outline the responsibilities and rights of both parties.
            Please read these terms carefully before proceeding with the
          ...
          <p>
            ...
            capable of entering into a legally binding agreement. By applying
            for merchant onboarding, you represent and warrant that you meet
          ...
          <p>
            <strong>3. Service Terms:</strong> Once approved, you will be bound
            by the specific terms and conditions related to our merchant
            services. These include, but are not limited to, transaction fees,
            payment processing timelines, and any additional terms outlined in
            your merchant agreement.
          </p>

          <p>
            <strong>4. Data Security:</strong> Protecting the confidentiality
            and security of your data is of utmost importance. LakiPay employs
            industry-standard security measures, but you are also responsible
            for safeguarding your login credentials and sensitive information.
          </p>
